...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            Log.v("Test Error Handling", "Resource tidak diketahui, error : ${e.message}")
        }
        ...
        val registrationUrl : TextView  = findViewById(R.id.registrationURl)
    ...
    private fun throwResourceNotFoundException() {
        throw Resources.NotFoundException("Resource not found for demonstration purposes")
    }
}